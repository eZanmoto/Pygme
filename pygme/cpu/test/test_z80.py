...
class TestZ80(unittest.TestCase):
    ...
    def test_addAA(self):
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, False)
        self.flagEq(self.z80.f.h, 0x7 + 0x7 > 0xf)
        self.flagEq(self.z80.f.c, 0x47 + 0x47 > 0xff)
        self.z80.a.ld(0xff)
        self.timeOp(opc, 1, 4)
        self.regEq(self.z80.a, 0xfe)
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, False)
        self.flagEq(self.z80.f.h, 0xf + 0xf > 0xf)
        self.flagEq(self.z80.f.c, 0xff + 0xff > 0xff)
        self.z80.a.ld(0x80)
        self.timeOp(opc, 1, 4)
        self.regEq(self.z80.a, 0x00)
        self.flagEq(self.z80.f.z, True)
    ...
    def test_adcAA(self):
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, False)
        self.flagEq(self.z80.f.h, 0xf + 0xf + 0x1> 0xf)
        self.flagEq(self.z80.f.c, True)
        self.z80.a.ld(0x01)
        self.timeOp(opc, 1, 4)
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, False)
        self.flagEq(self.z80.f.h, 0x1 + 0x1 + 0x01 > 0xf)
        self.flagEq(self.z80.f.c, False)
        self.z80.a.ld(0x01)
        self.timeOp(opc, 1, 4)
        self.regEq(self.z80.a, 0x02)
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, False)
        self.flagEq(self.z80.f.h, 0x1 + 0x1 > 0xf)
        self.flagEq(self.z80.f.c, False)
    ...
    def test_subAMemHL(self):
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0xc < 0xa)
        self.flagEq(self.z80.f.c, 0x9c < 0x2a)
        addr = 0xbeef
        self.z80.ldHLnn(addr >> 8, addr & 0xff)
        self.mem.set8(addr, 0xff)
        self.timeOp(opc, 2, 8)
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0x2 < 0xf)
        self.flagEq(self.z80.f.c, 0x72 < 0xff)
        addr = 0xbeef
        self.z80.ldHLnn(addr >> 8, addr & 0xff)
        ...
        self.flagEq(self.z80.f.z, True)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0x3 < 0x3)
        self.flagEq(self.z80.f.c, 0x73 < 0x73)
    ...
    def _test_sbcAR(self, opc, func, reg):
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0xc < 0xf)
        self.flagEq(self.z80.f.c, True)
        reg.ld(0x01)
        self.timeOp(opc, 1, 4)
        ...
        self.flagEq(self.z80.f.z, False)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0xd < 0x1)
        self.flagEq(self.z80.f.c, False)
        reg.ld(0x9b)
        self.timeOp(opc, 1, 4)
        self.regEq(self.z80.a, 0x00)
        self.flagEq(self.z80.f.z, True)
        self.flagEq(self.z80.f.n, True)
        self.flagEq(self.z80.f.h, 0xb < 0xb)
        self.flagEq(self.z80.f.c, 0x9b < 0x9b)

...
class TestZ80(unittest.TestCase):
    ...
    def test_incD(self):
        ...
        for i in range(1, 0x200):
            self.incOp8(opc, self.D, 1, 1, 4)
            self.regEq(self.D, i & 0xff)
    ...
    def test_rlA(self):
        ...
        self.z80.a = 0x80
        self.timeOp(opc, 1, 4)
        self.regEq(self.A, 0x00)
        self.flagEq(self.F_Z, z)
        self.flagEq(self.F_N, False)
        self.flagEq(self.F_H, False)
        self.flagEq(self.F_C, 1)
        self.timeOp(opc, 1, 4)
        self.regEq(self.A, 0x01)
        self.flagEq(self.F_Z, z)
        self.flagEq(self.F_N, False)
        self.flagEq(self.F_H, False)
        self.flagEq(self.F_C, 0)
        self.timeOp(opc, 1, 4)
        self.regEq(self.A, 0x02)
        self.flagEq(self.F_Z, z)
        self.flagEq(self.F_N, False)
        self.flagEq(self.F_H, False)
        self.flagEq(self.F_C, 0)
